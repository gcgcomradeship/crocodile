defmodule Crocodile.Item do
  ...
  @optional_fields ~w(partner_id vendor vendor_code name retail_price base_retail_price whole_price base_whole_price discount insale shipping_date description brutto batteries pack material length diameter collection images category subcategory color size)a
